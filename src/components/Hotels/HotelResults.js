                    ...
                    <div className='hotelMain flexXY'>
                        <div className='hotelMain-container'>
                            <div className='hotelMain-container-card'>
                                {hotelsResultData.length !== 0 ? (hotelsResultData.map((item, index) => (item.avgCostPerNight < maxrange && item.avgCostPerNight > minrange && (
                                ...
                                :
                                (<div className="nohotelsfound flexXY">
                                    <div>
                                        <div className="flexXY">{notrainsfound}</div>
                                        <h3>We couldn't find Hotels to match your filters</h3>
                                        <p>Please reset your filters to see Hotels</p>
                                    </div>
                                </div>)
                                }
                            </div>
