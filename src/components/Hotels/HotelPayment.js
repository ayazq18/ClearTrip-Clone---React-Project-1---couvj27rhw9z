...
export default function HotelPayment() {
  ...
  const object = [
    { month: 'Jan (01)' }, { month: 'Feb (02)' }, { month: 'Mar (03)' }, { month: 'April (04)' }, { month: 'May (05)' }, { month: 'Jun (06)' }, { month: 'Jul (07)' }, { month: 'Aug (08)' }, { month: 'Sep (09)' }, { month: 'Oct (10)' }, { month: 'Nov (11)' }, { month: 'Dec (12)' }
  ]
